...
> 
> 如果你正在使用插件的**2.0.0-2.0.2**版本，且mc服务端版本>=**26.1**，请务必升级插件至**2.0.3**，然后删除插件旧的配置文件重新生成，否则**下界**和**末地**生成的备份是错误的。具体问题见: https://github.com/Passion-Never-Dissipate/Chunk_BackUp/issues/4
